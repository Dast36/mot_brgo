...
import '../services/excel_exporter.dart'; // Aggiungi questo import
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _showPrintPreview() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => PrintPreviewScreen(filteredEngines: filteredEngines),
      ),
    );
  }
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  // Pulsante REG/SC (Registra/Scarico)
                  Expanded(
                    child: Container(
                      height: 40,
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          // Mostra modal per scegliere azione
                          showDialog(
                            context: context,
                                ...
                                content: Column(
                                  ...
                                  children: [
                                    ListTile(
                                      ...
                                      subtitle: Text('Registra l\'ingresso di un motore'),
                                      onTap: () {
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) => InventoryActionScreen(
                                              engine: filteredEngines.firstWhere(
                                                (e) => e.status == 'shipped',
                                                orElse: () => filteredEngines.isNotEmpty ? filteredEngines[0] : engines[0]
                                              ),
                                              isReceiving: true,
                                            ),
                                          ),
                                    ...
                                    ListTile(
                                      ...
                                      subtitle: Text('Registra l\'uscita di un motore'),
                                      onTap: () {
                                        Navigator.of(context).pop();
                                        Navigator.push(
                                          context,
            ...
            // Spazio tra pulsanti e statistiche
            SizedBox(height: 8),
...
// Nuova classe per l'anteprima di stampa
class PrintPreviewScreen extends StatelessWidget {
  final List<Engine> filteredEngines;

  const PrintPreviewScreen({Key? key, required this.filteredEngines}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Anteprima Stampa'),
        backgroundColor: Colors.blue[800],
        actions: [
          IconButton(
            icon: Icon(Icons.print),
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Documento inviato alla stampante'),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text(
                    'Totale motori: ${filteredEngines.length}',
                    style: TextStyle(fontSize: 14),
                  ),
                  SizedBox(height: 20),
                  ...
                  Container(
                    ...
                    child: Table(
                      ...
                      columnWidths: {
                        0: FlexColumnWidth(1.5), // Marca
                        1: FlexColumnWidth(2),   // Tipo
                        2: FlexColumnWidth(1),   // KW
                        3: FlexColumnWidth(1),   // V
                        4: FlexColumnWidth(1.2), // Forma
                        5: FlexColumnWidth(1),   // Giri
                        6: FlexColumnWidth(0.8), // Poli
                        7: FlexColumnWidth(1.5), // Location Code
                      },
                      children: [
                        // Intestazione tabella
                        TableRow(
                          ...
                          children: [
                            ...
                            _buildTableCell('KW', isHeader: true),
                            _buildTableCell('V', isHeader: true),
                            _buildTableCell('FORMA', isHeader: true),
                            _buildTableCell('GIRI', isHeader: true),
                            _buildTableCell('POLI', isHeader: true),
                            _buildTableCell('LOCATION CODE', isHeader: true),
                          ],
                        ),
                        // Righe dati
                        ...filteredEngines.map((engine) => TableRow(
                          children: [
                            _buildTableCell(engine.brand),
                            _buildTableCell(engine.modelType),
                            _buildTableCell(engine.power.toString()),
                            _buildTableCell(engine.voltage.toString()),
                            _buildTableCell(engine.form),
                            _buildTableCell(engine.rpm.toString()),
                            _buildTableCell(engine.poles.toString()),
                            _buildTableCell(engine.locationCode ?? ''),
                          ],
                        )).toList(),
                      ],
                    ),
